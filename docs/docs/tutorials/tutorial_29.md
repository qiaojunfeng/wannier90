...
-   Outline: *Calculate spin Hall conductivity (SHC) and plot Berry
    ...
    the [berry_task=shc: spin Hall conductivity](../../user_guide/postw90/berry#sec:shc) 
...
this [equation](../../user_guide/postw90/berry#mjx-eqn:eq:kubo_shc_berry) of the User Guide. 
